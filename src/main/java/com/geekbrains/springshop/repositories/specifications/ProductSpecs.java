package com.geekbrains.springshop.repositories.specifications;
...
public class ProductSpecs {
    ...
    public static Specification<Product> quantityGreaterThan(double value) {
        return (Specification<Product>) (root, criteriaQuery, criteriaBuilder) -> {
            return criteriaBuilder.greaterThan(root.get("quantity"), value);
        };
    }
}
